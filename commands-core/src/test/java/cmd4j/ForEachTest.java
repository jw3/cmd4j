...
public class ForEachTest {
	...
	public void function()
		...
		final List<String> random = CmdTests.randoms(5, 5);
		...
		Chains.create(Commands.forEach(random, builder)).invoke();
	}
	...
	public void results()
		...
		Assert.assertEquals(actual, Lists.transform(random, Functions2.function(toUpper())));
	}
